...
# benchmark_tax_rate <- 0.14
standard_VAT_rate = 0.14
preferential_VAT_rate = 0.05


Benchmark_tax_rate_bu <- 0.14
Standard_VAT_rate_bu <-0.14
Preferential_VAT_rate_bu <- 0.05

# Tax rates for simulation
Benchmark_tax_rate <- VAT_benchmark_tax_rate
# Standard_VAT_rate <-Standard_VAT_rate
# Preferential_VAT_rate <- Preferential_VAT_rate
